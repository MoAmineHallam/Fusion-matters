...
**File:** [`fig1_a_Additive.png`](../results/Figures/fig1_a_Additive.png)  
**Paper:** Figure 1a  
...
**File:** [`fig3_arxiv_paired_deltas_gateScalar_concat.png`](../results/Figures/fig3_arxiv_paired_deltas_gateScalar_concat.png)  
**Paper:** Figure 3  
...
**File:** [`fig4_a_arxiv_accuracy.png`](../results/Figures/fig4_a_arxiv_accuracy.png)  
**Paper:** Figure 4a  
**Description:** Mean test accuracy across fusion mechanisms on ArXiv.

---

## Figure 4b — ArXiv Inference Latency by Fusion
**File:** [`fig4_b_arxiv_latency.png`](../results/Figures/fig4_b_arxiv_latency.png)  
**Paper:** Figure 4b  
...
**File:** [`fig7_paired_deltas_imdb.png`](../results/Figures/fig7_paired_deltas_imdb.png)  
**Paper:** Figure 7  
